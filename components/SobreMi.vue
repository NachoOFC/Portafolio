    ...
    <div class="max-w-7xl w-full mx-auto px-4">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-start">
        ...
        <div class="flex flex-col items-center">
          ...
          <!-- MI STACK -->
          <div class="bg-gradient-card rounded-2xl shadow-2xl px-8 py-6 border border-blue-900/40 backdrop-blur-md w-full">
            <div class="text-gradient font-bold uppercase text-sm mb-4 text-center">MI STACK</div>
        ...
        <div class="flex flex-col justify-start">
          <h1 class="text-3xl lg:text-5xl font-bold mb-2 leading-tight">
            ...
            <span class="typing-text text-gradient whitespace-nowrap">{{ displayText }}</span>
          ...
          <p class="text-lg mb-8 text-gray-300 break-words">
          ...
          <div class="w-full flex flex-col mb-8">
            <h3 class="text-lg font-bold text-gradient mb-4">Tecnologías que conozco</h3>
