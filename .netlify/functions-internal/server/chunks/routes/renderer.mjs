...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[{"async":true,"defer":true,"src":"https://www.googletagmanager.com/gtag/js?id=G-5KSJVGFNBJ"},{"innerHTML":"window.dataLayer = window.dataLayer || [];\nfunction gtag(){dataLayer.push(arguments);}\ngtag('js', new Date());\ngtag('config', 'G-5KSJVGFNBJ');","type":"text/javascript","async":true,"defer":true}],"noscript":[]};
