...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2a0984fd-2ace-4bcd-a69e-a35b31046562",
...
const _lazy_Wjx_Hk = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Wjx_Hk, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_nuxt/builds/meta/**', handler: _lazy_Wjx_Hk, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/builds/**', handler: _lazy_Wjx_Hk, lazy: true, middleware: false, method: undefined },
  { route: '/_nuxt/**', handler: _lazy_Wjx_Hk, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Wjx_Hk, lazy: true, middleware: false, method: undefined }
];
